...
<body>
    ...
    <div id="horn">
        ...
        <div class="content1">
            ...
            <p class="home-intro">To see all types of cuisine and price ranges between food trucks,  click <a class="here" href="/ads ">here!</a></p>
                <div class="row">
                    <div class="column">
            ...
            <p class="home-intro">To see some unique food truck conversions from buses, ambulances, to missle launchers, click  click <a class="here" href="/ads ">here!</a></p>
            <div class="row">
                <div class="column">
            ...
            <p class="home-intro">Check out some tasty but funny named food trucks by clicking <a class="here" href="/ads ">here!</a></p>
            <div class="row">
                <div class="column">
            ...
            <p class="home-intro">Yes, even pets have food trucks, click <a class="here" href="/ads ">here!</a></p>
            <div class="row">
                <div class="column">
            ...
            <p class="home-intro">For Ad listing on new and used food trucks for sale, click <a class="here" href="/ads ">here!</a></p>
            <div class="row">
                <div class="column">
